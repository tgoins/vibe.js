		...
		this.playNextSong = () => {
			...
			let embed = {
				...
				author: {
					name: "Joker",
					url: 'https://github.com/tannerz28/vibe.js',
					icon_url: 'https://img.youtube.com/vi/' + video_id + '/hqdefault.jpg'
				},
				thumbnail: {
				...
				fields: [
					{
						name: 'Link',
						value: '[Click Here](' + 'https://www.youtube.com/watch?v=' + video_id + ')',
						inline: true
					}
				],
				footer: {
					text: '[Vibe.js](https://github.com/tannerz28/vibe.js) | The joy of music.'
				}
			};
