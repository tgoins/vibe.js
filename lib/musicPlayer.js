	...
	constructor() {
		...
		this.playNextSong = () => {
			...
			if(!BotState.voiceConnection) {
				BotState.voiceChannel.join().then(connection => {
			...
			let embed = {
				title: 'Now playing: "' + title + '" (requested by ' + user + ')',
				url: 'https://github.com/tannerz28/vibe.js',
				description: "Link: Click here", color=0x5050ed),
				author: {
					name: "Joker",
					url: 'https://github.com/tannerz28/vibe.js',
					icon_url: 'https://cdn0.iconfinder.com/data/icons/square-logo-buttons/512/discord-1-128.png'
				},
				thumbnail: {
					url: 'https://cdn0.iconfinder.com/data/icons/square-logo-buttons/512/discord-1-128.png'
				},
				fields: [
					{
						name: 'Link',
						value: '<a href="https://cdn0.iconfinder.com/data/icons/square-logo-buttons/512/discord-1-128.png">Click here</a>',
						inline: true
					}
				],
				footer: {
					text: 'Length: 3m 11s | Tuesday, October 10, 2017 at 10:23pm'
				}
			};
