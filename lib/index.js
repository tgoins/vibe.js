...
bot.on('ready', () => {
  ...
  var voiceChannel = server.channels.find(chn => chn.name.toLowerCase() === musicVoiceChannel.toLowerCase() || chn.id === musicVoiceChannel && chn.type === "voice"); //The voice channel the bot will connect to
...
bot.on('message', msg => {
  ...
  var server = bot.guilds.find("name", serverName);
  var voiceChannel = server.channels.find(chn => chn.name.toLowerCase() === musicVoiceChannel.toLowerCase() || chn.id === musicVoiceChannel && chn.type === "voice");
